	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('name') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <input id="name" type="text" name="name" class="input-xxlarge" maxlength="30" value="<?php echo set_value('name', isset($permissions->name) ? $permissions->name : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('description') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <input id="description" type="text"  class="input-xxlarge" name="description" maxlength="100" value="<?php echo set_value('description', isset($permissions->description) ? $permissions->description : ''); ?>" />
