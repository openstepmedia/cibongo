...
<div class="well shallow-well">
    <span class="filter-link-list">
        ...
        foreach ($letters as $letter) {
            echo anchor(
                    "{$index_url}first_letter-{$letter}", $letter, array('class' => $filterLetter && $letter == $first_letter ? 'active' : '')
            ) . PHP_EOL;
        }
        ?>
    </span>
...
<?php foreach ($roles as $role) : ?>
                <li><?php echo anchor("{$index_url}role_id-{$role->id}", $role->role_name); ?></li>
            <?php endforeach; ?>
        </ul>
    </li>
</ul>
    ...
    <?php foreach ($users as $user) : ?>
        ...
        if ($user->banned) :
            ?>
                    ...
                    <td class='last-login'>
        <?php if ($user->last_login instanceof DateTime) : ?>
                            <?php echo $user->last_login->format('m/d/Y H:iA'); ?>
                        <?php else : ?>
                            -- 
                        <?php endif; ?>
                    </td>
