...
<ul class="nav nav-pills">
	<li<?php echo $checkSegment == '' && $migrationsSegment != 'migrations' ? ' class="active"' : ''; ?>>
		<a href='<?php echo "{$developerUrl}/database_odm"; ?>'><?php echo lang('database_maintenance'); ?></a>
	</li>
	<li<?php echo $checkSegment == 'backups' ? ' class="active"' : ''; ?>>
		<a href='<?php echo "{$developerUrl}/database_odm/backups"; ?>'><?php echo lang('database_backups'); ?></a>
	</li>
	<li<?php echo $migrationsSegment == 'migrations' ? ' class="active"' : ''; ?>>
		<a href='<?php echo "{$developerUrl}/migrations_odm"; ?>'><?php echo lang('database_migrations'); ?></a>
	</li>
</ul>